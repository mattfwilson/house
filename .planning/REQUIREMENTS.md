...
- [ ] **CORE-01**: All financial math lives in a pure, framework-agnostic calculation core with zero React/Next dependencies (enforced by a lint boundary rule)
...
- [ ] **CORE-03**: The core is fully unit-tested, with deterministic functions (no ambient time/randomness inside the core)
...
- [ ] **ASMP-01**: All assumptions (tax rates, DTI thresholds, return assumptions, maintenance %, SWR) are configurable, stored data — never hardcoded
